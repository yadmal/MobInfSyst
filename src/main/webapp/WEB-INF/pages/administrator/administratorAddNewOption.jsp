        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12 py-2">
                    <ul class="nav nav-pills justify-content-around bg-dark text-light py-3">
                        <li class="nav-item text-uppercase text-light">
                            <a class="nav-link text-light active" href="administratorAddNewOption.html">add option
                <br> </a>
                        </li>
                        <li class="nav-item text-uppercase text-light">
                ...
                <br> </a>
                        ...
                        <li class="nav-item text-uppercase text-light">
                            <a class="nav-link text-light" href="administratorAddNewManager.html">add new manager
                <br> </a>
                        </li>
                        <li class="nav-item text-uppercase text-light">
        ...
        <div class="container-fluid">
            <div class="row justify-content-center">
                <div class="col-md-6 py-1">
                    <form:form id="formNewOption" modelAttribute="newOption" method="post" action="administratorOption">
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                <label for="inputDescription">Description</label>
                                        <form:input path="description" type="text" class="form-control" id="inputDescription" placeholder="Description"></form:input>
                                </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                 <label for="inputConnectionCost">Connection cost</label>
                                    <form:input path="connectionCost" type="number" class="form-control" id="inputConnectionCost" placeholder="Connection cost"></form:input>
                                </div>
                            <div class="form-group col-md-6">
                               <label for="inputPrice">Price</label>
                            <form:input path="price" type="number" class="form-control" id="inputPrice" placeholder="Price"></form:input>
                                </div>
                        </div>
                        <form:button value="submit" class="btn text-center text-uppercase btn-block btn-success">save</form:button>
                    </form:form>
                </div>
            </div>
        </div>
