      ...
      <div class="row">
        <div class="col-md-12 py-2">
          <ul class="nav nav-pills justify-content-around bg-dark text-light py-3">
            ...
            <li class="nav-item text-uppercase text-light">
              <a class="nav-link text-light active" href="administratorAddNewTariff.html">add tariff
                <br> </a>
            </li>
            <li class="nav-item text-uppercase text-light">
          ...
          <form>
            ...
            <div class="form-row">
              <div class="form-group col-md-6">
                ...
                <input type="number" class="form-control" id="inputConnectionCost" placeholder="Connection cost"> </div>
              <div class="form-group col-md-6">
