  ...
  <meta
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-12 py-2">
            <ul class="nav nav-pills bg-dark text-light py-4 justify-content-around">
              <li class="nav-item text-uppercase text-light">
                <a class="nav-link text-light" href="clientContracts.html">my contracts
                  <br> </a>
              </li>
              <li class="nav-item text-uppercase text-light">
              ...
              <li class="nav-item text-uppercase text-light">
                <a class="nav-link text-light active" href="clientOptions.html">options
                  <br> </a>
              </li>
            </ul>
          </div>
    ...
    <div class="bg-secondary text-white">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h1 class="text-dark text-center text-uppercase">options</h1>
          </div>
        </div>
      </div>
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <p class="lead">Contruct number: 01234567890</p>
          </div>
        </div>
      </div>
      <div class="container">
