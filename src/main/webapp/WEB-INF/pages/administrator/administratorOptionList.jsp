...
<body class="bg-dark border-secondary">&lt;%@ page contentType="text/html;charset=UTF-8" pageEncoding="UTF-8" language="java" %&gt; &lt;%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %&gt; &lt;%@ taglib uri="http://www.springframework.org/tags/form" prefix="form" %&gt;
  <meta
    charset="UTF-8">
        ...
        <div class="row">
          <div class="col-md-12 py-2">
            <ul class="nav nav-pills justify-content-around bg-dark text-light py-3">
              ...
              <li class="nav-item text-uppercase text-light">
                <a class="nav-link text-light active" href="administratorEditOption.html">option list
                  <br> </a>
              </li>
              <li class="nav-item text-uppercase text-light">
    ...
    <div class="p-0 bg-secondary">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h1 class="text-dark text-center text-uppercase">option list</h1>
          </div>
        </div>
      </div>
      <div class="container">
            ...
            <table class="table table-light table-hover text-center m-2">
              ...
              <tbody>
                <tr>
                  ...
                  <td>Good option</td>
                  <td>
                    <a class="btn btn-block text-uppercase btn-danger" href="clientOptions.html">delete</a>
                  </td>
                  <td></td>
                </tr>
                <tr>
