...
<div class="p-5 bg-secondary">
    <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1 class="text-dark text-center text-uppercase">list of options</h1>
                </div>
            </div>
        ...
        <div class="row">
            <c:if test="${!empty optionList}">
                <c:forEach items="${optionList}" var="option" varStatus="count">
                    <div class="p-3 align-self-center col-md-4">
                        <div class="card">
                            <div class="card-block p-5">
                                <h4><c:out value="${option.title}"/></h4>
                                <hr>
                                <p><c:out value="${option.description}"/></p>
                                <hr>
                                <h3>
                                    Price $: <c:out value="${option.price}"/>
                                </h3>
                                <h3>
                                    Connection $: <c:out value="${option.connectionCost}"/>
                                </h3>
                            </div>
                        </div>
                    </div>
